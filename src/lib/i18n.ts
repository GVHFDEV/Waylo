...
export const i18n = {
  ...
  pt: {
    ...
    concierge: {
      ...
      transport: { public: 'Transporte público', uber: 'Uber / Táxi', rental: 'Carro alugado', personal: 'Carro pessoal', walking: 'A pé' },
  ...
  en: {
    ...
    concierge: {
      ...
      transport: { public: 'Public transit', uber: 'Uber / Taxi', rental: 'Rental car', personal: 'Own car', walking: 'On foot' },
  ...
  fr: {
    ...
    concierge: { 
      ...
      transport: { public: 'Transport en commun', uber: 'Uber / Taxi', rental: 'Voiture de location', personal: 'Voiture personnelle', walking: 'À pied' },
      budget_placeholder: 'Ex : 5000', 
  ...
  de: {
    ...
    concierge: { 
      ...
      transport: { public: 'ÖPNV', uber: 'Uber / Taxi', rental: 'Mietwagen', personal: 'Eigenes Auto', walking: 'Zu Fuß' },
  ...
  it: {
    ...
    concierge: { 
      ...
      transport: { public: 'Trasporto pubblico', uber: 'Uber / Taxi', rental: 'Auto a noleggio', personal: 'Auto propria', walking: 'A piedi' },
  ...
  ja: {
    ...
    concierge: { 
      ...
      transport: { public: '公共交通', uber: 'Uber / タクシー', rental: 'レンタカー', personal: 'マイカー', walking: '徒歩' },
