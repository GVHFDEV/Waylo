...
export const i18n = {
  ...
  pt: {
    ...
    wizard: {
      ...
      step8: { title: 'Hospedagem (Opcional)', desc: 'Já sabe onde vai ficar? Se souber, usaremos como base — mas pode pular se preferir.' },
      ...
      hotel_hint: 'Sem problema se ainda não tiver definido — a IA vai cuidar da logística automaticamente.',
    ...
    concierge: {
      ...
      transport: { public: 'Transporte público', uber: 'Uber / Táxi', rental: 'Carro alugado', personal: 'Carro pessoal', walking: 'A pé', other: 'Outros' },
      currency_label: 'Moeda da Viagem',
  ...
  en: {
    ...
    wizard: {
      ...
      step8: { title: 'Hotel / Accommodation (Optional)', desc: 'Already know where you\'re staying? We\'ll use it — but you can skip this if you prefer.' },
      ...
      hotel_hint: 'No worries if you haven\'t decided yet — the AI will handle the logistics for you.',
      last_step: 'Last Step',
    ...
    concierge: {
      ...
      transport: { public: 'Public transit', uber: 'Uber / Taxi', rental: 'Rental car', personal: 'Own car', walking: 'On foot', other: 'Other' },
      currency_label: 'Trip Currency',
  ...
  fr: {
    ...
    concierge: { 
      ...
      transport: { public: 'Transport en commun', uber: 'Uber / Taxi', rental: 'Voiture de location', personal: 'Voiture personnelle', walking: 'À pied', other: 'Autre' },
      currency_label: 'Monnaie du Voyage',
      budget_placeholder: 'Ex : 5000', 
  ...
  de: {
    ...
    concierge: { 
      ...
      transport: { public: 'ÖPNV', uber: 'Uber / Taxi', rental: 'Mietwagen', personal: 'Eigenes Auto', walking: 'Zu Fuß', other: 'Sonstige' },
      currency_label: 'Reisewährung',
  ...
  it: {
    ...
    concierge: { 
      ...
      transport: { public: 'Trasporto pubblico', uber: 'Uber / Taxi', rental: 'Auto a noleggio', personal: 'Auto propria', walking: 'A piedi', other: 'Altro' },
      currency_label: 'Valuta del Viaggio',
  ...
  ja: {
    ...
    concierge: { 
      ...
      transport: { public: '公共交通', uber: 'Uber / タクシー', rental: 'レンタカー', personal: 'マイカー', walking: '徒歩', other: 'その他' },
      currency_label: '旅行通貨',
