...
export function buildItineraryPrompt(payload: ItineraryPayload): string {
  return `[SYSTEM IDENTITY & PRIME DIRECTIVE]
...
export function parseAndValidateItinerary(rawContent: string) {
